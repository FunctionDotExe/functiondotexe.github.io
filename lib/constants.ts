...
export const PROJECTS: Project[] = [
  {
    ...
    mediaFit: "contain",
    metric: "Six daily games · iOS, Android & web",
    link: "",
    visual: "gradient",
  },
  {
    title: "ForgeFountain",
    description:
      "A market tool for Hypixel SkyBlock players. It compares Bazaar prices with crafting and forging costs, then helps players inspect profit, demand, and time requirements.",
    stack: ["JavaScript", "Node.js", "Express", "APIs"],
    ...
    mediaFit: "contain",
    metric: "Live prices & recipe analysis",
    link: "https://github.com/FunctionDotExe/ForgeFountain",
    visual: "wireframe",
  },
  {
    ...
    metric: "Real-time detection · team of five",
    link: "",
    visual: "voronoi",
  },
  {
...
export const RESEARCH_PROJECTS = [
  {
    ...
    description: "I built a GPU-accelerated CNN pipeline to distinguish melanoma from nevi using HAM10000, a source dataset of 10,015 dermatoscopic images.",
    detail: "The project evaluation reported approximately 0.90 AUC and 89–91% validation accuracy. A Fairlearn audit found a 4.45% accuracy gap and different false-negative rates by sex. The dataset total describes the source collection, not the size of a held-out evaluation set.",
    tools: ["Python", "TensorFlow / Keras", "GPU acceleration", "Fairlearn"],
    metrics: [{ value: "HAM10000", label: "Source dataset" }, { value: "CNN", label: "Classification method" }, { value: "Fairlearn", label: "Fairness evaluation" }],
  },
  {
