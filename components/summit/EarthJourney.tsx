    ...
    <div className="earth-journey" data-journey-chapter="depth">
      ...
      <section className="descent-threshold" id="descent" aria-labelledby="descent-title">
        <div className="threshold-stage">
          <div className="threshold-copy" data-narrative-scene>
      ...
      <section className="depth-section descent-mantle" id="experience" tabIndex={-1} aria-labelledby="experience-title" data-narrative-scene>
        <div className="shell depth-grid">
          ...
          <div className="experience-list">
            {EXPERIENCE.map((item, index) => (
              <details className="disclosure experience-entry" key={item.company} open={index === 0} data-hover-disclosure data-expedition-stop={`experience-${index}`} data-stop-label={item.company} data-stop-duration="2000">
      ...
      <section className="contact-scene" id="contact" tabIndex={-1} aria-labelledby="contact-title">
        <div className="shell">
          <div className="contact-scene__content" data-narrative-scene data-expedition-stop="contact" data-stop-label="The next adventure" data-stop-duration="1600"><p className="section-label">Every ending is a trailhead</p><h2 id="contact-title">What’s our<br />next adventure?</h2><p>A team to join. An idea to build. A question worth following.<br />I’d love to hear what you’re thinking.</p><ContactActions /></div>
