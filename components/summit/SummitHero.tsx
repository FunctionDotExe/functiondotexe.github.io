      ...
      <div className="journey-hero__stage shell">
        <div className="journey-hero__content">
          ...
          <div className="hero-actions">
            <a className="journey-button" href="#work">Explore my work <ArrowDownRight size={18} aria-hidden="true" /></a>
        ...
        <a className="summit-marker" href="#basecamp"><span className="summit-marker__point" aria-hidden="true"/><span>The summit<small>Every idea starts somewhere.</small></span></a>
